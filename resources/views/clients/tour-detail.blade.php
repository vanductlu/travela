                ...
                <div class="row justify-content-between">
                    <div class="col-xl-6 col-lg-7">
                        <div class="tour-header-content mb-15" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            <span class="location d-inline-block mb-10"><i class="fal fa-map-marker-alt"></i> {{ $tourDetail->destination }}a</span>
                        ...
                        <div class="col-md-6">
                            <div class="tour-include-exclude mt-30">
                                ...
                                <ul class="list-style-one check mt-25">
                                    <li><i class="far fa-check"></i> Dịch vụ đưa đón</li>
                                    <li><i class="far fa-check"></i> 1 bữa ăn mỗi ngày</li>
                                    <li><i class="far fa-check"></i> Tiệc tối trên du thuyền & sự kiện âm nhạc</li>
                                    ...
                                    <li><i class="far fa-check"></i> Xe buýt du lịch cao cấp</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="tour-include-exclude mt-30">
                                ...
                                <ul class="list-style-one mt-25">
                                    ...
                                    <li><i class="far fa-times"></i> Bữa trưa, đồ ăn & thức uống</li>
                                    <li><i class="far fa-times"></i> Nâng cấp tùy chọn lên ly thủy tinh</li>
                ...
                <div class="comments mt-30 mb-60">
                    <div class="comment-body" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="author-thumb">
                            <img src="{{ asset('clients/assets/images/blog/comment-author1.j') }}pg" alt="Author">
                        </div>
                        <div class="content">
                    ...
                    <div class="comment-body comment-child" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="author-thumb">
                            <img src="{{ asset('clients/assets/images/blog/comment-author2.j') }}pg" alt="Author">
                        </div>
                        <div class="content">
                    ...
                    <div class="comment-body" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="author-thumb">
                            <img src="{{ asset('clients/assets/images/blog/comment-author3.j') }}pg" alt="Author">
                        </div>
                        <div class="content">
            ...
            <div class="col-lg-4 col-md-8 col-sm-10 rmt-75">
                <div class="blog-sidebar tour-sidebar">
                    ...
                    <div class="widget widget-contact" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <h5 class="widget-title">Cần giúp đỡ?</h5>
                        <ul class="list-style-one">
                            <li><i class="far fa-envelope"></i> <a href="emilto:nvd2k3@gmail.com">nvd2k3@gmail.com</a></li>
                            <li><i class="far fa-phone-volume"></i> <a href="callto:0364869849">0364869849</a></li>
                        </ul>
                    </div>           
                </div>
            </div>
